window.twentyfifty.views.costs_sensitivity = function() {
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
    ...
    costsSensitivityHTML = "<div class='costssensitivity'>\n  <ul id='comparatorchoice'>\n    <li>\n      <a href=\"#\" onclick=\"$('ul#view_comparatorchoice').toggle(); return false;\">Choose comparison<img alt=\"Dropdown-arrow\" src=\"/assets/images/dropdown-arrow.png\" /></a>\n      <ul class='choices' id='view_comparatorchoice'>\n <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('1011111111111110111111001111100111101101101110110111');$('ul#view_comparatorchoice').toggle(); return false;\">All at level 1</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('2022222222222220222222002222200222202202202220220222');$('ul#view_comparatorchoice').toggle(); return false;\">All at level 2</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('3033333333333330333333003333300333303303303330330333');$('ul#view_comparatorchoice').toggle(); return false;\">All at level 3</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('4044444444444440444444004444400444404404404440440444');$('ul#view_comparatorchoice').toggle(); return false;\">All at level 4</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('1011111111111110111111004424400444404204304440420111');$('ul#view_comparatorchoice').toggle(); return false;\">Maximum demand, no supply</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('4044444444444440443424001121100111101102101110110111');$('ul#view_comparatorchoice').toggle(); return false;\">Maximum supply, no demand</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('e0d3jrg21cci2110222112004423200444404202304440420141');$('ul#view_comparatorchoice').toggle(); return false;\">Higher renewables, more energy efficiency</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('1022212333222320433313003213300332303103303230310231');$('ul#view_comparatorchoice').toggle(); return false;\">20% emissions target, sample 1</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('3031222222222220324313004414400334303102303320310231');$('ul#view_comparatorchoice').toggle(); return false;\">20% emissions target, sample 2</a></li>\n  <li><a href=\"#\" onclick=\"twentyfifty.switchComparator('1041332232322230212224003313400444404102304330410441');$('ul#view_comparatorchoice').toggle(); return false;\">20% emissions target, sample 3</a></li>\n        </ul>\n    </li>\n  </ul>\n  <h1>The cost of your pathway compared with another, allowing simple variation in cost estimates.</h1>\n  <div id='costssensitivity'></div>\n  " + window.costEssentialNotesHTML + "\n</div>";
