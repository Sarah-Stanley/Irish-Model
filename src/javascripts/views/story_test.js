window.twentyfifty.views.story = function() {
  ...
  this.updateResults = function(pathway) {
    ...
    this.stories_for_choices(element, "Transport in 2050", 25, 26, 27, 29);
    ...
    this.stories_for_choices(element, "Aviation in 2050", 28, 29, 30);
    ...
    this.stories_for_choices(element, "Wave, tidal, hydro and micro wind in 2050", 6, 7, 8, 13);
  ...
  this.stories_for_choices = function(element, title) {
    ...
    for (_i = 0, _len = rows.length; _i < _len; _i++) {
      ...
      if (choice % 1 === 0.0) {
        ...
        text.push(window.twentyfifty.longDescriptions[row][Math.floor(choice)] + " and " + window.twentyfifty.longDescriptions[row][Math.ceil(choice)]);
      }
    };
