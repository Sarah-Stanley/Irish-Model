(function() {
  ...
  window.costEssentialNotesHTML = "<div id='essentialnotes'>\n  <br><strong>Note: The cost of failing to tackle climate change is not included. To see individual cost assumptions, please download the <a href=\"/assets/excel/model.xlsx\">Excel model</a>.</strong>\n</div>";
